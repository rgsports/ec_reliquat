...
<div id="ec_reliquat" class="card">
    <div class="card-header">
        <h3 class="card-header-title">
            {l s='Cancel Products' mod='ec_reliquat'}
        </h3>
    </div>
    <div class="card-body">
        <form action="{$url_form}" method="post"  enctype="multipart/form-data">
            ...
            <div class="row-margin-top">
                <h3>
                    {l s='Informacion de Cancelacion' mod='ec_reliquat'}
                </h3>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-horizontal">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <label class="form-control-label" for="ec_trackingNumber">{l s='Razon de cancelacion' mod='ec_reliquat'}</label>
                                    <input type="text" id="ec_trackingNumber" name="cancelation_reason" class="form-control" placeholder="">
                                    <small class="form-text">{l s='Ingrese razon de cancelacion breve (interno)' mod='ec_reliquat'}</small>
                                </div>
                            </div>
                           {*  <div class="col-lg-9">
                                <div class="form-group row type-choice">
                            ...
                            <div class="col-lg-9">
                                <input type="hidden" name="id_order" value="{$ec_id_order}">
                                <button type="submit" name="submitEcReliquatCancel" class="btn btn-primary pull-left" style="margin-top: 10px;">Cancelar</button>
                            </div>
                        </div>
                    </div>
                </div>
