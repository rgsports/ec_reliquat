...
<div id="ec_reliquat" class="card">
    ...
    <div class="card-body">
        <form action="{$url_form}" method="post"  name="cancelform" enctype="multipart/form-data">
            <table class="table">
                <thead>
                    <tr class="nodrag nodrop">
                        <th></th>
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ec_trackingNumber" name="cancelation_reason"  required class="form-control" placeholder="">
